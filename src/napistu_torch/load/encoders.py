...
from napistu_torch.load.constants import ENCODINGS, ENCODING_MANAGER
...
DEFAULT_ENCODERS = {
    ENCODINGS.CATEGORICAL: OneHotEncoder(handle_unknown="ignore", drop='first', sparse_output=False),
